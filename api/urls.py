...
urlpatterns = [
    ...
    path('todosUser/', views.TodoUserList.as_view()),
    path('todosUser/create', views.TodoUserCreate.as_view()),
    path('todosUser/update/<int:int>', views.TodoUserUpdate.as_view()),
    path('todosUser/delete/<int:id>', views.TodoUserDestroy.as_view()),
